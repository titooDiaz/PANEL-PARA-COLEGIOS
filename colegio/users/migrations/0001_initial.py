    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(blank=True, related_name='profesor_grupos', to='auth.group', verbose_name='groups')),
                ...
                ('user_permissions', models.ManyToManyField(blank=True, related_name='profesor_permisos', to='auth.permission', verbose_name='profesor_permissions')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(blank=True, related_name='alumno_grupos', to='auth.group', verbose_name='groups')),
                ('user_permissions', models.ManyToManyField(blank=True, related_name='alumno_permisos', to='auth.permission', verbose_name='user_permissions')),
            ],
            options={
                'verbose_name': 'user',
                'verbose_name_plural': 'users',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sexo', models.CharField(choices=[('Hombre', 'Hombre'), ('Mujer', 'Mujer'), ('Sin informacion', 'Sin informacion')], default='Sin informacion', max_length=20)),
                ('estado', models.BooleanField(default=True)),
                ('groups', models.ManyToManyField(blank=True, related_name='administrador_grupos', to='auth.group', verbose_name='groups')),
                ('user_permissions', models.ManyToManyField(blank=True, related_name='administrador_permisos', to='auth.permission', verbose_name='administrador_permissions')),
            ],
            options={
                'verbose_name': 'user',
                'verbose_name_plural': 'users',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_documento', models.CharField(choices=[('Sin Informacion', 'Sin Informacion'), ('Tarjeta de Identidad', 'Tarjeta de Identidad'), ('Cédula de Ciudadanía', 'Cédula de Ciudadanía'), ('Cédula de Extranjería', 'Cédula de Extranjería'), ('Registro Civil de Nacimiento', 'Registro Civil de Nacimiento'), ('Permiso Especial de Permanencia', 'Permiso Especial de Permanencia')], default='Sin informacion', max_length=50)),
                ('numero_documento', models.CharField(blank=True, max_length=20, null=True)),
                ('tipo_usuario', models.CharField(choices=[('Profesor', 'Profesor'), ('Alumno', 'Alumno'), ('Gestor', 'Gestor'), ('Administrador', 'Administrador')], default='Gestor', max_length=50)),
                ('fecha_creacion', models.DateTimeField(auto_now_add=True)),
                ('sexo', models.CharField(choices=[('Hombre', 'Hombre'), ('Mujer', 'Mujer'), ('Sin informacion', 'Sin informacion')], default='Sin informacion', max_length=20)),
                ('estado', models.BooleanField(default=True)),
                ('groups', models.ManyToManyField(blank=True, related_name='gestor_grupos', to='auth.group', verbose_name='groups')),
                ('user_permissions', models.ManyToManyField(blank=True, related_name='gestor_permisos', to='auth.permission', verbose_name='gestor_permissions')),
            ],
            options={
                'verbose_name': 'user',
                'verbose_name_plural': 'users',
