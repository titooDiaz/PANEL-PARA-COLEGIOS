...
class CustomUserProfesores(AbstractUser):
    groups = models.ManyToManyField(
        ...
        verbose_name='groups',
        blank=True,
        related_name='alumno_user_set',  # Cambia esto a tu preferencia
    )
    ...
    foto = models.ImageField(default='profesores/profile.png', upload_to=user_directory_path_profile, null=True, blank=True)
    ...
    titular = models.ForeignKey('informacion.Grado', on_delete=models.SET_NULL, blank=True, null=True)  # Utiliza 'informacion.Grado')  # Campo ForeignKey para relacionar con Grado
