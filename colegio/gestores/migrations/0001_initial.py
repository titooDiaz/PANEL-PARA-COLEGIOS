    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('foto', models.ImageField(blank=True, default='gestores/profile.png', null=True, upload_to=gestores.models.user_directory_path_profile)),
                ...
                ('groups', models.ManyToManyField(blank=True, related_name='gestor_user_set', to='auth.group', verbose_name='groups')),
                ('user_permissions', models.ManyToManyField(blank=True, related_name='gestor_user_set', to='auth.permission', verbose_name='user permissions')),
            ],
            options={
                'verbose_name': 'user',
