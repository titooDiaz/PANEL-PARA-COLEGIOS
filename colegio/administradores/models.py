...
class CustomUserAdministrador(AbstractUser):
    groups = models.ManyToManyField(
        ...
        verbose_name='groups',
        blank=True,
        related_name='administradores_user_set',  # Cambia esto a tu preferencia
    )
    ...
    foto = models.ImageField(default='administradores/profile.png', upload_to=user_directory_path_profile, null=True, blank=True)
