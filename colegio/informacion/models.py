...
class Grado(models.Model):
    ...
    director = models.ForeignKey(User, on_delete=models.SET_NULL, blank=True, null=True, related_name='grado_director')
    alumnos = models.ManyToManyField(User, blank=True, related_name='grado_alumnos')
