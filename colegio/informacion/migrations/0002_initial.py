...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='materias',
            name='profe',
            field=models.ManyToManyField(blank=True, related_name='materias_grado', to='users.customuserprofesores'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='grado',
            name='horario',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='informacion.horariodiario'),
        ),
        migrations.AddField(
            model_name='grado',
            name='horario_partes',
